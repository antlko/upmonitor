...
[![Docker image](https://img.shields.io/badge/ghcr.io-anatolkzh%2Fupmonitor-2496ED?logo=docker&logoColor=white)](https://github.com/anatolkzh/upmonitor/pkgs/container/upmonitor)
...
docker run -d \
  ...
  ghcr.io/anatolkzh/upmonitor:latest
```
...
services:
  upmonitor:
    image: ghcr.io/anatolkzh/upmonitor:latest
...
```bash
git clone https://github.com/anatolkzh/upmonitor.git
cd upmonitor
